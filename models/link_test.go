...
func TestLink_EncodeLink(t *testing.T) {
	...
	assert.Equal(t, string(encoded), `{"id":1,"code":"abcde","longUrl":"https://roboncode.com","shortUrl":"https://ac.me/abcde","created":"0001-01-01T00:00:00Z"}`, "EncodeLink failed to match")
}
